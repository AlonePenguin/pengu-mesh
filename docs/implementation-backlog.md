...
- the next serious lane expands scenario gates beyond the current startup-readiness/operator-diagnosis/structured-failure manifest into repeated live-web, weak-prompt, fresh-agent, and PinchTab comparison proof
