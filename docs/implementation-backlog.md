...
- the next serious lane expands scenario gates beyond startup-readiness into repeated live-web, weak-prompt, fresh-agent, operator-diagnosis, and PinchTab comparison proof
